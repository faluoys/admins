<template>
    ...
    >
        ...
        >
            ...
            <n-form style="display: flex;flex-wrap: wrap;justify-content: space-between" ref="formRef" :model="model"
                    :rules="rules">
                ...
                <n-row style="width: 720px;position: absolute;bottom: 20px;" :gutter="[0, 24]">
                    <n-col :span="24">
                        <div
                            style="display: flex; justify-content: flex-end;flex-wrap: nowrap;justify-content: space-around">
                            <n-button
                                round
                                type="primary"
                                @click="userSubmit"
