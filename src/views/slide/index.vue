<template>
    <div>
        ...
        <div class="content px-4">
            ...
            <EditSlide v-if="showEditModal" :slide_id="slide_id" :showModal="showEditModal"
                       @checkShowModal="checkEditModal" @reloadTable="reload"></EditSlide>
            <DeleteSlide v-if="showDelModal" :slide_id="slide_id" :showModal="showDelModal"
                         @checkShowModal="checkDelModal" @reloadTable="reload"></DeleteSlide>
        </div>
    </div>
</template>
...
const getUserList = (params: { current?: any; name?: string; email?: string; }) => {
    loadingBar.start();
