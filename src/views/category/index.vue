<template>
    <div>
        ...
        <div class="content px-4" style="text-align: left">
            ...
            <EditCategory v-if="showEditModal" :dataName="data" :category_id="category_id" :showModal="showEditModal"
                          @checkShowModal="checkEditModal" @reloadTable="reload"></EditCategory>
        </div>
    </div>
</template>
...
const columns: any = [
    ...
    },
    {
        ...
        width: "10%",
        align: "center",
        sorter: (row1: any, row2: any) => row1.seq - row2.seq,
    },
    {
        title: "操作",
        key: "created_at",
