<template>
    <div>
        ...
        <div class="content px-4">
            ...
            <EditUser v-if="showEditModal" :user_id="user_id" :showModal="showEditModal"
                      @checkShowModal="checkEditModal" @reloadTable="reload"></EditUser>
        </div>
    </div>
</template>
